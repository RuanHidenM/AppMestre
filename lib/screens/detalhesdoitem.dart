...
class DetalhesDoItem extends StatefulWidget {
  DetalhesDoItem({required this.produtoId});
...
class _detalhesDoItem extends State<DetalhesDoItem> {
  ...
  final _detalheProdutoDao = DetalheProdutoDao();
  late ProdutoDetalhe _produtoDetalhe ;

  void initState(){
    super.initState();
    _detalheProdutoDao.findDetalheProduto(widget.produtoId).then((value){
      setState(() {
        _produtoDetalhe = value;
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    //_detalheProdutoDao.findDetalheProduto(widget.produtoId).then((value) => print('Detalhes $value'));
    //_detalheProdutoDao.findDetalheProdutoIMG(widget.produtoId);
    return Scaffold(
        appBar: AppBar(
          title: Center(
              child: Text(
        ...
        body: Container(
          child: FutureBuilder<ProdutoDetalhe>(
            future: _detalheProdutoDao.findDetalheProduto(widget.produtoId),
            builder: (context, snapshot){
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text('Cód:${_produtoDetalhe.Produtoreferencia}', style: TextStyle(
              ...
              return Center(child: Text('Algo deu errado :C'));
            },
          ),
        )
